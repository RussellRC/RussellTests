...
import org.russell.algorithms.ds.Tree.Node;
...
//    }
    ...
    public void testDistance() {
        assertEquals(Tree.distance(letterTree.root, "F", "A"), 2);
        assertEquals(Tree.distance(letterTree.root, "F", "H"), 3);
        assertEquals(Tree.distance(letterTree.root, "E", "H"), 6);
        assertEquals(Tree.distance(letterTree.root, "B", "C"), 2);
    }
