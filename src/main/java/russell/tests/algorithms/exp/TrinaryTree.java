...
public class TrinaryTree {
        ...
        while (node.right != null || node.left != null) {
            if (node.right != null && value > node.right.data) {
                ...
                if (node.left.mid != null) {
                    ...
                    Node temp = getMostToTheRightNode(node.left);
    ...
    static Node deleteNode_Russell(Node root, int value) {
        if (root == null) {
     ...
     * @return
     */
    static Node deleteNode(Node node, Node parent, Node promoted) {
    ...
    static Node getMostToTheRightNode(Node node) {
        Node temp = node;
